  ...
  return (
    <div className="w-full max-w-5xl space-y-8 text-center lg:text-left">
      <section className="space-y-5">
        <h3 className="title-font scrap-tape-title text-4xl text-[#ff5ca8] sm:text-5xl">
          {copy.skillStackTitle}
        </h3>
        <div
          ref={skillsGridRef}
          className="rounded-none border border-[#8ab5b2] bg-transparent p-4 shadow-lg sm:p-5"
        >
          <div className="tetris-board relative mx-auto grid h-[30rem] w-full max-w-4xl grid-cols-6 grid-rows-8 gap-2 overflow-hidden rounded-none border border-[#4c6f74] p-3 sm:h-[34rem] sm:p-4">
        ...
        <h2 className="title-font scrap-tape-title mt-24 text-4xl text-[#ff5ca8] sm:mt-28 sm:text-5xl">
          {copy.servicesTitle}
        </h2>
      </section>

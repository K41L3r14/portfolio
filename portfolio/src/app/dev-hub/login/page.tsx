  ...
  return (
    <main className="min-h-screen bg-[#f7f3ec] px-4 py-10 text-[#1f1b17] sm:px-6">
      <div className="mx-auto w-full max-w-md rounded-2xl border border-[#2d2926] bg-[#fdf8f1] p-6">
        <p className="description-font text-xs uppercase tracking-[0.35em] text-[#3b332b]">Dev Hub</p>
        <h1 className="title-font mt-2 text-4xl text-[#c94841]">Private Login</h1>
